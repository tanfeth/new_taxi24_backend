...
{
    /// <inheritdoc />
    public partial class AddRejectedTemplateAndReminderTemplates2 : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 6, "يرجى إكمال المعلومات للتسجيل معنا في تاكسي 24", "Please complete the information to register with us at Taxi 24", null, null, false, 6, "عملية التسجيل لم تكتمل", "Registration Process not complete", null },
                    { 7, "يرجى إكمال المعلومات للتسجيل معنا في تاكسي 24", "مرحبًا [DriverName]، للأسف تم رفض بعض مستنداتك، يرجى إعادة إرسالها لمواصلة تسجيلك.", null, null, false, 7, "عملية التسجيل لم تكتمل", "يرجى إعادة تقديم المستندات المرفوضة", null }
                });
